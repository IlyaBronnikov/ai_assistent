...
├── prompts/                # Системные промпты и шаблоны диалогов
├── knowledge_base/         # База знаний (услуги, врачи, FAQ)
├── integrations/           # Скрипты интеграции (Google Calendar, API)
...
1. Склонируйте репозиторий:
   ```bash
   git clone https://github.com/ваш-логин/ai-dental-assistant.git
   ```

2. Установите зависимости (при наличии).
3. Настройте доступ к Савви и подключите бота.
4. Загрузите свою базу знаний.
5. Настройте интеграцию с календарём или системой записи.
6. Запустите и тестируйте!

## 🤝 Вклад в проект

Приветствуются предложения по улучшению, исправления ошибок и новые интеграции. Создавайте issue или отправляйте pull request.
